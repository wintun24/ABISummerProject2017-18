...
#iron.DiagnosticsSetOn(iron.DiagnosticTypes.IN, [1, 2, 3, 4, 5], "diagnostics",["BoundaryConditions_NeumannIntegrate"])
...
fields.NodesExport("CylinderResultsAlter","FORTRAN")

fields.ElementsExport("CylinderResultsAlter","FORTRAN")
