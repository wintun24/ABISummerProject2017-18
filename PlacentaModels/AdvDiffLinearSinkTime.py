...
equationsSetSpecification = [iron.EquationsSetClasses.CLASSICAL_FIELD,
        ...
        iron.EquationsSetSubtypes.LINEAR_SOURCE_ADVECTION_DIFFUSION]
...
sourceField.ComponentValuesInitialiseDP(iron.FieldVariableTypes.U,iron.FieldParameterSetTypes.VALUES,1,-0.5)
...
for vnode in vList:
  ...
  independentField.ParameterSetUpdateNodeDP(iron.Fiel#block commented code is for reading in darcy velocity info - add in later.dVariableTypes.U, iron.FieldParameterSetTypes.VALUES, 1, 1, int(vnode[0]), int(3), vnode[3])
'''
...
problemSpecification = [iron.ProblemClasses.CLASSICAL_FIELD,
        ...
        iron.ProblemSubtypes.LINEAR_SOURCE_ADVECTION_DIFFUSION]
...
controlLoop.TimesSet(0.0, 1.0001, 0.001)
...
fml.OutputAddFieldNoType(baseName+".source", dataFormat, sourceField,
    iron.FieldVariableTypes.U, iron.FieldParameterSetTypes.VALUES)
fml.OutputWrite("AdvDiffConstSinkResults.xml")
fml.Finalise()
