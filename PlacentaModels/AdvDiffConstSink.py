...
equationsSetSpecification = [iron.EquationsSetClasses.CLASSICAL_FIELD,
        ...
        iron.EquationsSetSubtypes.CONSTANT_SOURCE_STATIC_ADVEC_DIFF]
...
sourceField.ComponentValuesInitialiseDP(iron.FieldVariableTypes.U,iron.FieldParameterSetTypes.VALUES,1,-1.0)
